...
public class SharpenMaskedCommand implements Command {
  ...
  /**
   * Constructor to initialize the command object for masked sharpen component extraction.
   *
   ...
   */
  public SharpenMaskedCommand(ImageModelV3 imageModel, String operationName,
