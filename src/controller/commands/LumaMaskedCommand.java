...
public class LumaMaskedCommand implements Command {
  ...
  /**
   * Constructor to initialize the command object for masked luma component extraction.
   *
   ...
   */
  public LumaMaskedCommand(ImageModelV3 imageModel, String operationName,
