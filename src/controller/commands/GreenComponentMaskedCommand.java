...
public class GreenComponentMaskedCommand implements Command {
  ...
  /**
   * Constructor to initialize the command object for masked green component extraction.
   *
   ...
   */
  public GreenComponentMaskedCommand(ImageModelV3 imageModel, String operationName,
