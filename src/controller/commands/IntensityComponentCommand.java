...
/**
 * Command class to apply the intensity component to the specified image.
 */
public class IntensityComponentCommand implements Command {
  ...
  public void execute() {
    if (percent != null) {
      imageModel.intensityComponentImageSplit(imageName, newImageName, percent);
    } else {
      imageModel.applyComponent(imageName, newImageName, ComponentType.INTENSITY);
    }
  }
}
