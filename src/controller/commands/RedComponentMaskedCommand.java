...
public class RedComponentMaskedCommand implements Command {
  ...
  /**
   * Constructor to initialize the command object for masked red component extraction.
   *
   ...
   */
  public RedComponentMaskedCommand(ImageModelV3 imageModel, String operationName,
